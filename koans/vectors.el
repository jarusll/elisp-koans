...
(elisp-koans/deftest
 ...
 (should (eq t (cl-typep [1 11 111] 'vector)))
...
and expand it using `vconcat'"
 ...
 (should (eq t (cl-typep #&4"	" 'bool-vector)))
...
(elisp-koans/deftest
 ...
 ;; commenting line below because aref's second argument is required,
 ;; maybe this is a bad test case
