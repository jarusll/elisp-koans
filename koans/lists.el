...
`elt' is similar to `nth', with the arguments reversed."
 (let ((noms '("peanut" "butter" "and" "jelly")))
   (should (equal "peanut" (cl-first noms)))
   (should (equal "butter" (cl-second noms)))
   (should (equal "jelly" (cl-fourth noms)))
...
(elisp-koans/deftest
 ...
 (let ((noms '("peanut" "butter" "and" "jelly")))
   (should (equal '("peanut") (cl-subseq noms 0 1)))
   (should (equal '("peanut" "butter") (cl-subseq noms 0 2)))
   (should (equal '() (cl-subseq noms 2 2)))
   (should (equal '("and" "jelly") (cl-subseq noms 2)))))
